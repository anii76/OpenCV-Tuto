...
#img src, cntours counter, number (-1 = all) , color, thickness
    if area > 300:
      ...
      cv2.putText(imi, objectType, (x+(w//2)-10, y+(h//2)-10), cv2.FONT_HERSHEY_COMPLEX, 0.7, (255,0,0), 2)
      

path = "farah\FB_IMG_15674554720632965.jpg"
img = cv2.imread(path)
...
hor3 = np.vstack((hor1, cv2.cvtColor(hor2, cv2.COLOR_GRAY2BGR) ))

hor = cv2.resize(hor3, (1200,600))
